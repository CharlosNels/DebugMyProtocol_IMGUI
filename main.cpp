...
int main(int, char **)
{
    ...
    SDL_Window *window = SDL_CreateWindow("Gluttonous snake", SDL_WINDOWPOS_CENTERED, SDL_WINDOWPOS_CENTERED, 1280, 720, window_flags);
    if (window == nullptr)
    {
    ...
    ImFont* font = io.Fonts->AddFontFromMemoryTTF((void *)CN_font_data, CN_font_size, 22.0f, nullptr, io.Fonts->GetGlyphRangesChineseFull());
